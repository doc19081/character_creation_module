...
def attack(char_name: str, char_class: str) -> str:
    """Задаём урон в зависимости от класса персонажа."""
...
def defence(char_name: str, char_class: str) -> str:
    """Задаём параметры блока в зависимости от класса персонажа."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Задаём специальное умение в зависимости от класса персонажа."""
    if char_class == 'warrior':
